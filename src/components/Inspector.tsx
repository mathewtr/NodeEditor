...
interface InspectorProps {
    ...
    onClose: () => void;
    onUpdateParameter: (nodeId: string, paramName: string, value: number | number[]) => void;
}
...
interface ParameterInputProps {
    ...
    value: number | number[];
    nodeId: string;
    onUpdate: (nodeId: string, paramName: string, value: number | number[]) => void;
}
    ...
    return (
        <div className="param-input-row">
            ...
            <input
                ...
                placeholder={Array.isArray(value) ? "e.g., 1, 1, 1, 1" : "number"}
            />
        </div>
    );
}
    ...
    return (
        <div className="inspector-panel">
            ...
            <div className="inspector-content">
                ...
                {/* App Parameter (for connector nodes) */}
                {selectedNode.data?.appParameter && (
                    <div className="inspector-section">
                        <label>App Parameter</label>
                        <p className="app-parameter">→ {selectedNode.data.appParameter}</p>
                    </div>
                )}
                ...
                {editableParams.length === 0 && !selectedNode.data?.appParameter && (
                    <div className="inspector-section">
